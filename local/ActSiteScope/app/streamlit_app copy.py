            ...
            setTimeout(function() {
                try {
                    ...
                    if(appData.mode === "individual") {
                        ...
                        var labeledIds = new Set();
                        if(appData.consensus) {
                            appData.consensus.forEach(h => {
                                var resNo = parseInt(h.ResNo); labeledIds.add(resNo);
                        ...
                        if(appData.vis_mcsa && appData.mcsa) {
                            appData.mcsa.forEach(mc => {
                                var resNo = parseInt(mc.res_num); if(labeledIds.has(resNo)) return;
